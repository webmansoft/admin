...
namespace plugin\admin\app\logic\tool;

use think\db\exception\DbException;
use think\db\exception\DataNotFoundException;
use think\db\exception\ModelNotFoundException;
use plugin\admin\utils\Zip;
use plugin\admin\utils\Helper;
use plugin\admin\utils\Template;
use plugin\admin\basic\BaseLogic;
use plugin\admin\exception\ApiException;
use plugin\admin\app\model\system\SystemMenu;
use plugin\admin\app\model\tool\GenerateTables;
use plugin\admin\app\model\tool\GenerateColumns;
...
class GenerateTablesLogic extends BaseLogic
{
     ...
     * @return void
     */
    public function destroy($ids, bool $force = false)
    {
    ...
    public function preview($id): array
    {
        ...
        $template_name = '/plugin/admin/stub/admin';
        if (isset($table['stub']) && $table['stub'] != '') {
            $template_name = '/plugin/admin/stub/' . $table['stub'];
        }
    ...
    {
        $zip_path = runtime_path() . DIRECTORY_SEPARATOR . 'admin';
        if (!is_dir($zip_path)) {
    ...
    public function genUnit($table_id, $tables)
    {
        ...
        $class = new \ReflectionClass('plugin\admin\utils\GenStruct');
