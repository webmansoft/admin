...
use plugin\admin\app\logic\system\SystemUserLogic;
...
class BaseController
{
     ...
     * @return Response
     */
    public function success(array $data = [], string $msg = 'success'): Response
    {
        if (is_string($data)) {
            $msg = $data;
        }
    ...
    protected function init()
    {
        ...
        // 接口权限认证
        $server_auth = config('plugin.admin.project.server_auth', false);
        if ($server_auth) {
