...
class Cache
{
    ...
    {
        $isCache = config('plugin.admin.project.cache.enable', false);
        $cacheType = config('plugin.admin.project.cache.type', 'file');
        $cachePrefix = config('plugin.admin.project.cache.prefix','cache_');
